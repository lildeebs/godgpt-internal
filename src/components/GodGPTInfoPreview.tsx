...
const GodGPTInfoPreview: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0a] via-[#1a0a2e] to-[#0a0a0a] bg-black text-white">
      {/* Hero Section */}
      <section className="relative px-5 pt-16 pb-20 md:px-8 md:pt-24 md:pb-32">
        <div className="max-w-6xl mx-auto">
          {/* Mystical glow effect */}
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-purple-500/20 rounded-full blur-[120px] pointer-events-none"></div>
...
export default GodGPTInfoPreview
